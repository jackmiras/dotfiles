...
ln -s "${HOME}/Projects/dotfiles/neovim-config/colors" "$HOME/.config/nvim"
ln -s "${HOME}/Projects/dotfiles/neovim-config/indent" "$HOME/.config/nvim"
...
mkdir -p "$HOME/.vim"
ln -s "${HOME}/Projects/dotfiles/neovim-config/colors" "$HOME/.vim"
ln -s "${HOME}/Projects/dotfiles/neovim-config/indent" "$HOME/.vim"
